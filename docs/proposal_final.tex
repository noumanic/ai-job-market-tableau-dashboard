...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
  ...
  \item \textbf{Career Progression Analytics} --- How does salary grow from Entry (\$102{,}430) to Executive (\$195{,}896)?
...
Project Repo    & \url{https://github.com/noumanic/ai-job-market-tableau-dashboard} \\
...
1 & Line Chart
  & Salary Trend
  & Year-over-year average and median salary from 2020 to 2025
    showing five years of AI compensation growth.
    \newline\textit{Fields:} \texttt{work\_year}, \texttt{salary\_in\_usd} \\

2 & Bar Chart
  & Salary by Role
  & AI job categories ranked by average USD salary with a parameter
    toggle for Top 5 / Top 10 / All 15 roles.
    \newline\textit{Fields:} \texttt{job\_title} (grouped), \texttt{salary\_in\_usd} \\

3 & Donut Chart
  & Work Mode Split
  & On-site (79\%) vs.\ Remote (21\%) vs.\ Hybrid (0.2\%) breakdown
    of all submissions.
    \newline\textit{Fields:} \texttt{remote\_ratio} \\

4 & Map
  & Global AI Hiring
  & Choropleth world map shaded by average salary per country,
    with submission count in the tooltip.
    \newline\textit{Fields:} \texttt{company\_location}, \texttt{salary\_in\_usd} \\

5 & Bar Chart
  & Salary vs Experience
  & Average and median salary across Entry, Mid, Senior, and
    Executive levels with a line overlay.
    \newline\textit{Fields:} \texttt{experience\_level}, \texttt{salary\_in\_usd} \\

6 & KPI Cards
  & Summary KPIs
  & Five headline metrics: median salary, mean salary, total records,
    remote \%, EX/EN ratio.
    \newline\textit{Fields:} Multiple aggregated measures \\
\bottomrule
\end{tabularx}
\end{table}
...
Dual-Axis Chart
  ...
  & Submission count as bars on the secondary axis, overlaid with the
    average salary line on the primary axis --- shows both data volume
    growth and compensation growth simultaneously. \\

Global Filters
  & All Sheets
  & Four dropdown filters (Work Year, Experience Level, Company Size,
    Employment Type) connected to all sheets simultaneously via
    Tableau filter actions. \\

Highlight Actions
  & All Sheets
  & Clicking any bar, country, or data point highlights the
    corresponding records across every other chart on the dashboard. \\

Parameter Toggle
  & Salary Bar Chart
  & A Tableau parameter lets the viewer switch between Top 5, Top 10,
    and All 15 role categories dynamically via a calculated rank field. \\

Stacked Bar
  & Remote Trend (Sheet 7)
  & A seventh sheet showing year-over-year On-site vs.\ Remote
    vs.\ Hybrid as 100\% stacked bars --- illustrating the remote
    collapse from 53\% (2022) to 20\% (2025). \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}[leftmargin=2em, itemsep=8pt]
  ...
  \item Stack Overflow. (2024). \textit{Developer Survey 2024}.
        \\\url{https://survey.stackoverflow.co}

  \item McKinsey \& Company. (2024). \textit{The State of AI in 2024}.
        McKinsey Global Institute.
        \\\url{https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai}

  \item World Economic Forum. (2025). \textit{Future of Jobs Report 2025}.
        \\\url{https://www.weforum.org/reports/the-future-of-jobs-report-2025}

  \item Few, S. (2012). \textit{Show Me the Numbers: Designing Tables and Graphs
        to Enlighten} (2nd ed.). Analytics Press.
